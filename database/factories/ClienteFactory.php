...
class ClienteFactory extends Factory
{
    ...
    {
        return [
            'clie_nombre' => $this->faker->name(),
            'clie_eps' => $this->faker->randomElement(['ALIANSALUD ENTIDAD PROMOTORA DE SALUD S.A.', 'ASOCIACIÓN INDÍGENA DEL CAUCA',
            ...
            'clie_direccion' => $this->faker->address(),
            'clie_ciudad' => $this->faker->randomElement(['MEDELLÍN',
                'ABEJORRAL',
                'ABRIAQUÍ',
                'ALEJANDRÍA',
                'AMAGÁ',
                ...
                'SANTA ROSALÍA',
                'CUMARIBO']),
            'clie_telefono' =>$this->faker->e164PhoneNumber,
            'clie_tipo_id'=> 'CC',
            'clie_numero_id' => $this->faker->unique()->randomNumber(9),
            'clie_estado'=>'ACTIVO',
        ];
    }
}
