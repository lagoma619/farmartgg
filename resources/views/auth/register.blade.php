<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="documento_numero" value="{{ __('Número identificación') }}" />
                <x-input id="documento_numero" class="block mt-1 w-full" type="text" name="documento_numero" :value="old('documento_numero')" required autocomplete="documento_numero" />
            </div>
